...
<head>
	...
	<style type="text/css">
		body{background: url(<?= base_url('public/assets/images/blood5.jpg') ?>)no-repeat fixed;background-size: 100% 100%   }
	...
	<div class="col l4 m12 s12">
		...
		<!---Php Meassge Show --->
			...
			<div class="card-content" id="login_id_with_image">
				...
				<h5 class="center-align" style="margin-top: 0px; color: orange;font-weight: 500">Blood Bank Access Control</h5>
				...
				<a href="<?= base_url('Blood_bank_registration/forget_password'); ?>" style="text-decoration: underline;margin-top: 10px; font-weight: 500">Forget Password ?</a>
				<a href="<?= base_url('Blood_bank_registration/index'); ?>" style="text-decoration: underline; margin-left: 10%; margin-top: 10px; font-weight: 500">Create Account</a>
				<br>
