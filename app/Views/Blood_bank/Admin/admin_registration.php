...
<head>
	...
	<style type="text/css">
		body{background: url(<?= base_url('public/assets/images/blied.jpg') ?>)no-repeat fixed;background-size: 100% 100%   }
...
<div class="row" style="margin-top: 6%;">
	...
	<div class="col l4 m12 s12">
		<!---card Section --->
		<?= form_open('Blood_bank_registration/admin_registerd'); ?>
		...
		<!---Php Meassge Show --->
			<div class="card-content" id="login_id_with_image">
				...
				<h5 class="center-align" style="margin-top: 0px; color: orange;font-weight: 500">Blood Bank Admin Registration</h5>
