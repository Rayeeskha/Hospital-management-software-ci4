...
<head>
	...
	<style type="text/css">
		body{background: url(<?= base_url('public/assets/images/blood2.png') ?>)no-repeat fixed;background-size: 100% 100%   }
	...
	<div class="col l4 m12 s12">
		...
		<!---Php Meassge Show --->
			<div class="card-content" id="login_id_with_image">
				...
				<h5 class="center-align" style="margin-top: 0px; color: orange;font-weight: 500">Blood Bank Donor Registration</h5>
				...
				<h6 style="font-size: 14px; font-weight: 500;color: orange;">Photo</h6>
				...
				<br>
				<a href="<?= base_url('Blood_bank_registration/login_account'); ?>"class="btn waves-effect waves-light" style="background: #ff3d00;text-transform: capitalize;width: 100%;font-weight: 500;margin-top: 10px;height: 40px;border-radius: 3px;">I have already Account ?</a>
			</div>
		</div>
		<?= form_close(); ?>
		<!---card Section --->
