...
<head>
	...
	<style type="text/css">
		body{background: url(<?= base_url('public/assets/images/doctor1.jpg') ?>)no-repeat fixed;background-size: 100% 100%   }
	...
	<div class="col l4 m12 s12">
		...
		<!---Php Meassge Show --->
			<div class="card-content" id="login_id_with_image">
				...
				<h5 class="center-align" style="margin-top: 0px; color: orange;font-weight: 500">Doctor Access Control</h5>
