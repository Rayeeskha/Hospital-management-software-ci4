...
<html>
<head>
	<title>Today Discharge Patients</title>
	<!---Include Css File --->
...
<div style="margin-right: 15px;margin-left: 15px;">
	<div class="card">
		<div class="card-content" style="border-bottom: 1px dashed silver;padding: 10px;">
			<h5 style="font-weight: 500;margin-top: 5px; font-size: 20px;"><span class="fa fa-users" style="color: green"></span>&nbsp;Today Discharge Patients </h5>
		</div>
			...
			<div class="row">
				...
				<div class="col l6 m6 s12">
					...
					<ul class="dropdown-content" id="doctor_filter">
						<li><a href="<?= base_url('Doctor/filter_today_discharge_patient/new_patient'); ?>" class="waves-effect">
							<span class="fa fa-trophy" style="color: #005a87"></span>&nbsp;New  Company </a></li>
						<li><a href="<?= base_url('Doctor/filter_today_discharge_patient/old_patient'); ?>" class="waves-effect">
				...
				<tr>
					...
					<td style="color: red">
						<?php if($t_patient['status'] == 'Ddischarge'): ?>
							<h6 style="color: red;font-size: 15px;"><?php echo 'Today Discharge Patient' ?></h6>
						<?php endif; ?>
					</td>
					<td>
						<h6>
