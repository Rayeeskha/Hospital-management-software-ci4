...
<div style="margin-right: 15px;margin-left: 15px;">
	<div class="card" style="box-shadow: none;">
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 5px;">
			<h5 style="font-weight: 500;color: orange"><span class="fa fa-flask" style="color: #005a87"></span>&nbsp;Manage Doctor Discharge Patents</h5>
		</div>
			...
			<div class="row">
				...
				<div class="col l6 m6 s12">
					...
					<ul class="dropdown-content" id="doctor_filter">
						...
						<li><a href="<?= base_url('Admin/filter_doc_dis_patents/new_patents'); ?>" class="waves-effect">
							<span class="fa fa-users" style="color: #005a87"></span>&nbsp;New  Patients </a></li>
						<li><a href="<?= base_url('Admin/filter_doc_dis_patents/old_patents'); ?>" class="waves-effect">
					...
					<tr>
						...
						<td>
							...
							<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $pat_rec['id']; ?>">
								<li><a href="<?= base_url('Admin/discharge_pateints/'.$pat_rec['id']); ?>" target="_blank"><span class="fa fa-print" style="color: #005a87;"></span>&nbsp;Discharge Patients</a></li>
							</ul>
						<!---Action Dropdown --->
						</td>
