...
<div style="margin-right: 15px;margin-left: 15px;">
	<div class="card" style="box-shadow: none;">
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 5px;">
			<h5 style="font-weight: 500"><span class="fa fa-flask" style="color: #005a87"></span>&nbsp;Manage Medicines</h5>
		</div>
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 10px;">
			<!--Search Bar & Filter Bar Section Start -->
			<div class="row">
				<div class="col l6 m6 s12">
					<?= form_open('Medical_Accountent/search_medicine'); ?>
					<ul id="search_doctor">
						<li>
				...
				<div class="col l6 m6 s12">
					...
					<ul class="dropdown-content" id="doctor_filter">
						...
						<li><a href="<?= base_url('Medical_Accountent/filter_medicine/new_medicine'); ?>" class="waves-effect">
							<span class="fa fa-users" style="color: #005a87"></span>&nbsp;New  Medicine </a></li>
						<li><a href="<?= base_url('Medical_Accountent/filter_medicine/old_medicine'); ?>" class="waves-effect">
				...
				foreach($mediciens as $pat_rec): ?>
					<tr>
						...
						<td>
							...
							<?php endforeach; ?>
							<h6 style="color: green;font-size: 14px;"><?= number_format($total_stock); ?></h6>
							<?php else: ?>
								<h6 style="color: red;font-size: 14px;">Product Not Sale</h6>
							<?php endif; ?>
						...
						<td>
							...
							?>
							<h6 style="color: orange; font-size: 14px;"><?= number_format($in_stock); ?></h6>
							
						</td>
						<td>
							<h6 style="color: red;font-size: 14px"><?= number_format($pat_rec['med_stock']); ?></h6>
						</td>
						<td>
							<span class="fa fa-clock" style="color: green">&nbsp;<?= date('D, M. d Y',strtotime($pat_rec['expiry_date'])); ?></span>
						</td>
						...
						<td>
							...
							<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $pat_rec['id']; ?>">
								<li><a href="<?= base_url('Medical_Accountent/add_medicine_stock/'.$pat_rec['id']); ?>"><span class="fa fa-edit" style="color: #005a87;"></span>&nbsp;Add Stock</a></li>
								<li><a href="<?= base_url('Medical_Accountent/edit_medicine/'.$pat_rec['id']); ?>"><span class="fa fa-edit" style="color: #005a87;"></span>&nbsp;Edit</a></li>
								
								<li><a href="<?= base_url('Medical_Accountent/delete_medicine/'.$pat_rec['id']); ?>" onclick="return confirm('Are you sure you want to  delete this Medicine Details?..');"><span class="fa fa-trash" style="color: red;"></span>&nbsp;Delete</a></li>

								<?php if ($pat_rec['status'] == "Active"):  ?>
								<li><a href="<?= base_url('Medical_Accountent/change_medicine_status/'.$pat_rec['id'].'/InActive'); ?>">
									<span class="fa  fa-eye-slash" style="color: red"></span>&nbsp;
								InActive</a></li>
								<?php else: ?>
									<li><a href="<?= base_url('Medical_Accountent/change_medicine_status/'.$pat_rec['id'].'/Active'); ?>"><span class="fa fa-eye" style="color: #005a87"></span>&nbsp;Active</a></li>
								<?php endif; ?>
							</ul>
						<!---Action Dropdown --->
						</td>
