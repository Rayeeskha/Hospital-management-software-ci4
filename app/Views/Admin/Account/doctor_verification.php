...
<div style="margin-right: 15px;margin-left: 15px;">
	<div class="card">
		<div class="card-content" style="border-bottom: 1px dashed silver;padding: 5px;">
			<h5 style="font-weight: 500"><span class="fa fa-users" style="color: #005a87"></span>&nbsp;Verify Doctor Account</h5>
		</div>
				...
				<div class="col l6 m6 s12">
					...
					<ul class="dropdown-content" id="doctor_filter">
						...
						<li><a href="<?= base_url('Admin/filter_doctor_verification/new_doc_account'); ?>" class="waves-effect">
							<span class="fa fa-users" style="color: #005a87"></span>&nbsp;New Doctor Accountent </a></li>
						<li><a href="<?= base_url('Admin/filter_doctor_verification/old_doc_account'); ?>" class="waves-effect">
							<span class="fa fa-users" style="color: #005a87"></span>&nbsp;Old Doctor Accountent</a></li>
					</ul>
				</div>	
	...
	<div class="card-content">
		<table class="table">
			...
			<?php if($doctors):
			count($doctors);
			foreach($doctors as $acc_account): ?>
				<tbody>
					<tr>
						<td>
							<center>
						...
						<td>
							...
							<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $acc_account['id']; ?>">
								...
								<li><a href="<?= base_url('Admin/delete_doc_account/'.$acc_account['id']); ?>" onclick="return confirm('Are you sure you want to  delete this Verification?..');"><span class="fa fa-trash" style="color: red;"></span>&nbsp;Delete</a></li>

								<?php if ($acc_account['status'] == "AdminVerification"):  ?>
								<li><a href="<?= base_url('Admin/change_doc_acc_status/'.$acc_account['id'].'/Active'); ?>">
									<span class="fa  fa-eye-slash" style="color: green"></span>&nbsp;
								Active</a></li>
								<?php else: ?>
									<li><a href="<?= base_url('Admin/change_doc_acc_status/'.$acc_account['id'].'/InActive'); ?>"><span class="fa fa-eye" style="color: #005a87"></span>&nbsp;InActive</a></li>
								<?php endif; ?>
							</ul>
						<!---Action Dropdown --->
						</td>
				...
				<div class="card" style="padding: 5px">
					<div class="card-content" style="background: red;padding: 3px;">
						<h6 style="color: white;font-weight: 500;margin-left: 20px;">
							<span class="fa fa-times"></span>&nbsp;Not any Verification for Doctor</h6>
					</div>
				</div>
			<?php endif; ?>
		</table>		
