...
<html>
<head>
	<title>Revist Patents Details</title>
	<!---CSS File Include  -->
...
<div class="container">
	<div class="card" style="box-shadow: none;">
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 10px;">
			<h5 style="font-weight: 500;margin-top: 5px; font-size: 20px;"><span class="fa fa-users"></span>&nbsp;Revisit Patents Details</h5>
		</div>
		<div class="card-content">
			<?= form_open('Admin/update_revisit_patient/'.$patents[0]->id); ?>
				<div class="row">
				...
				<input type="hidden" name="patient_id" id="input_box" value="<?= $patents[0]->id; ?>">
				<center>
					<button type="submit" id="btn_register_now" class="btn btn-waves-effect waves-light" style="text-transform: capitalize;font-weight: 500;font-size: 16px;background: #005a87;margin-top: 30px;"><span class="fa fa-user"></span>&nbsp;Revist Patents Details</button>
				</center>
			<?= form_close(); ?>
		</div>
		</div>
