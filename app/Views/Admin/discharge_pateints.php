...
<div style="margin-right: 15px; margin-left: 15px;">
	<div class="card" style="box-shadow: none;">
			...
			<div class="row">
				<div class="col l12 m12 s12">
					<div class="row">
						...
						<h6 style="font-size: 15px;font-weight: 500">Patient Name : <?= $patents[0]->patent_name; ?></h6>
						<h6>Patient Mobile : <a href="tel:<?= $patents[0]->patent_phone; ?>"><?= $patents[0]->patent_phone; ?></a></h6>
						<h6>Patient Address : <?= $patents[0]->patent_address; ?></h6>	
						</div>
		...
		<div class="card-content" style="border-bottom: 1px dashed silver">
			...
			<h6><?= $patents[0]->patent_issue; ?></h6>
		</div>
		<div class="card-content">
			
			<?=  form_open('Admin/add_patent_charge/'.$patents[0]->id); ?>
			<div class="row">
