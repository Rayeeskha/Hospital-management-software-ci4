	...
	<div class="card" style="box-shadow: none;">
					...
					<div class="row">
						...
						<h6 style="font-size: 15px;font-weight: 500">Patient Name : 
							<?php
								...
								echo $get_patient[0]->patent_name;
							?>
						...
						<h6>Patient Mobile : 
							...
							<a href="tel:<?= $get_patient[0]->patent_phone; ?>">
								<?= $get_patient[0]->patent_phone; ?></a>
							</h6>
						<h6>Patient Address : <?= $get_patient[0]->patent_address; ?>
							
						</h6>	
						</div>
						<div class="col l6 m6 s6" style="text-align: center;">
							<h6>Admit Date : 
								<?= date('d M, Y', strtotime($get_patient[0]->created_at)); ?>
							</h6>
		...
		<div class="card-content" style="border-bottom: 1px dashed silver">
			...
			<h6>
				...
				<?php 
					echo $get_patient[0]->patent_issue;
				?>
