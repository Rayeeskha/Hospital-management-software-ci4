			...
			<div class="row">
				...
				<div class="col l6 m6 s12">
					...
					<ul class="dropdown-content" id="doctor_filter">
						...
						<li><a href="<?= base_url('Admin/filter_blogs/new_blogs'); ?>" class="waves-effect" style="border-bottom: 1px dashed silver">
	...
	<div class="card-content">
		...
		<?php foreach($blogs_content as $blog): ?>	
			<tr>
				...
				<td>
					<a href="<?= base_url('Admin/view_blog/'.$blog['id']) ?>" target="_blank">View Post</a>
				</td>
				<td>
					<?= $blog['created_date']; ?>
				</td>
				...
				<td>
					...
					<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $blog['id']; ?>">
						<li><a href="<?= base_url('Admin/delete_blogs/'.$blog['id']); ?>" onclick="return confirm('Are you sure you want to  delete this Post?..');"  style="border-bottom: 1px dashed silver"><span class="fa fa-trash" style="color: red;"></span>&nbsp;Delete</a></li>
						<?php if ($blog['status'] == "Active"):  ?>
							<li><a href="<?= base_url('Admin/change_blog_status/'.$blog['id'].'/Publish'); ?>">
							<span class="fa  fa-eye" style="color: green"></span>&nbsp;
								Publish</a></li>
							<?php else: ?>
							<li><a href="<?= base_url('Admin/change_blog_status/'.$blog['id'].'/Active'); ?>"><span class="fa fa-flash" style="color: #005a87"></span>&nbsp;Active</a></li>
						<?php endif; ?>
					</ul>
						<!---Action Dropdown --->
				</td>
