...
<div style="margin-right: 15px;margin-left: 15px;">
	<div class="card" style="box-shadow: none;">
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 5px;">
			<h5 style="font-weight: 500"><span class="fa fa-flask" style="color: #005a87"></span>&nbsp;Manage Patents</h5>
		</div>
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 10px;">
			<!--Search Bar & Filter Bar Section Start -->
			<div class="row">
				<div class="col l6 m6 s12">
					<?= form_open('Admin/search_patent'); ?>
					<ul id="search_doctor">
						<li>
				...
				<div class="col l6 m6 s12">
					...
					<ul class="dropdown-content" id="doctor_filter">
						...
						<li><a href="<?= base_url('Admin/filter_patents/new_patents'); ?>" class="waves-effect">
							<span class="fa fa-users" style="color: #005a87"></span>&nbsp;New  Patients </a></li>
						<li><a href="<?= base_url('Admin/filter_patents/old_patents'); ?>" class="waves-effect">
					...
					<tr>
						...
						<td>
							...
							<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $pat_rec['id']; ?>">
								<li><a href="<?= base_url('Admin/edit_patents/'.$pat_rec['id']); ?>"><span class="fa fa-edit" style="color: #005a87;"></span>&nbsp;Edit</a></li>
								
								<li><a href="<?= base_url('Admin/delete_patents/'.$pat_rec['id']); ?>" onclick="return confirm('Are you sure you want to  delete this Patents Details?..');"><span class="fa fa-trash" style="color: red;"></span>&nbsp;Delete</a></li>

								<?php if ($pat_rec['status'] == "Active"):  ?>
								<li><a href="<?= base_url('Admin/change_patents_status/'.$pat_rec['id'].'/InActive'); ?>">
									<span class="fa  fa-eye-slash" style="color: red"></span>&nbsp;
								InActive</a></li>
								<?php else: ?>
									<li><a href="<?= base_url('Admin/change_patents_status/'.$pat_rec['id'].'/Active'); ?>"><span class="fa fa-eye" style="color: #005a87"></span>&nbsp;Active</a></li>
								<?php endif; ?>

								<li><a href="<?= base_url('Admin/print_slip/'.$pat_rec['id']); ?>" target="_blank" ><span class="fa fa-print" style="color: #005a87;"></span>&nbsp;Print  Slip</a></li>
