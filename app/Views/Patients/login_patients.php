...
<html>
<head>
	<title>Patients Acccount Login</title>
	<?= view('Admin/css_file.php'); ?>
	<style type="text/css">
		body{background: url(<?= base_url('public/assets/images/pat.jpg') ?>)no-repeat fixed;background-size: 100% 100%   }
...
<div class="row" style="margin-top: 5%;">
	...
	<div class="col l4 m12 s12">
		...
		<!---card Section --->
		<?= form_open('Patients_login/login_account'); ?>
		<div class="card">
			<!---Php Meassge Show --->
			<div >
		...
		<!---Php Meassge Show --->
			...
			<div class="card-content" id="login_id_with_image">
				...
				<a href="<?= base_url('Patients/forget_password'); ?>" style="text-decoration: underline;margin-top: 10px; font-weight: 500">Forget Password ?</a>
				<a href="<?= base_url('Patients_login/index'); ?>" style="text-decoration: underline; margin-left: 10%; margin-top: 10px; font-weight: 500">Create Account</a>
				<br>
